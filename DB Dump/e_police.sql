...
-- Database: `e_police`
--
CREATE DATABASE IF NOT EXISTS `e_police` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `e_police`;
...
DROP TABLE IF EXISTS `quizcompleted`;
...
--
ALTER TABLE `video`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;COMMIT;
